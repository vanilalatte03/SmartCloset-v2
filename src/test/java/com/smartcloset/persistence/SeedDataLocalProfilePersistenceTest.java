...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:h2:mem:seed-local;MODE=MySQL;DATABASE_TO_LOWER=TRUE;"
                + "CASE_INSENSITIVE_IDENTIFIERS=TRUE"
})
@Transactional
class SeedDataLocalProfilePersistenceTest {
    ...
    @Test
    void loadsDemoUserAndSeedClothesForLocalProfile() {
