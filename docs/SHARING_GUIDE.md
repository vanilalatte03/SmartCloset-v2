...
KMA_READ_TIMEOUT=3s
KMA_REQUEST_TIMEOUT=5s
KMA_STALE_CACHE_TTL=30m
KMA_MAX_ATTEMPTS=2
KMA_RETRY_BACKOFF=200ms
KMA_CIRCUIT_BREAKER_FAILURE_THRESHOLD=3
KMA_CIRCUIT_BREAKER_OPEN_DURATION=30s
...
CLOTHING_ANALYSIS_MAX_ATTEMPTS=2
CLOTHING_ANALYSIS_RETRY_BACKOFF=200ms
CLOTHING_ANALYSIS_CIRCUIT_BREAKER_FAILURE_THRESHOLD=3
CLOTHING_ANALYSIS_CIRCUIT_BREAKER_OPEN_DURATION=30s
...
| `KMA_STALE_CACHE_TTL` | KMA 장애 시 마지막 정상 KMA 값을 stale fallback으로 사용할 수 있는 최대 시간. 기본 `30m` |
