...
- 필요하면 `docs/qa/mvp9-ui-ux-redesign-qa.md`에 수동 QA 결과를 기록한다.
- 데스크톱 1440px과 모바일 390px에서 Auth, 추천, 옷장, 내 취향, 위치, 기록, 계정 설정 화면을 확인한다.
...
2. 최종 체크리스트를 확인한다:
   ...
   - 1440px 데스크톱과 390px 모바일에서 7개 화면의 겹침/잘림 QA가 기록되었는가?
